...
public class Contacto {
    ...
    public Contacto(int id, String nonbre, String primerApellido, String segundoApellido, String cumpleanos, String email, String telefono1, String telefono2, String direccion) {
        this.id = id;
        this.nonbre = nonbre;
